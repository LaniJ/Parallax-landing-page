...
function handleSlideBtnClick(e) {
  ...
  e.currentTarget.id === 'prev' 
    ...
    // dispatchEvent is used to create a custom event
    // which can be added as an event listener like "click"
    slideContainer.dispatchEvent(new Event("sliderMove"))
} 

// remove/add attributte function
...
// document.querySelectorAll('[data-slide] img').addEventListener('ondrag', )
...
contactForm.addEventListener('submit', handelFormSubmit);
